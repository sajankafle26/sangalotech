...
const BlogCard: React.FC<{ post: BlogPost; }> = ({ post }) => (
    <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300 group flex flex-col">
        ...
        <div className="p-6 space-y-4 flex flex-col flex-grow">
            ...
            <h3 className="text-xl font-bold text-gray-800 line-clamp-2 flex-grow">{post.title}</h3>
...
// Fix: Modified component to accept 'posts' prop to display dynamic data.
const Blogs: React.FC<{ posts: BlogPost[] }> = ({ posts }) => {
    return (
        <section className="blog py-10 bg-gray-100">
            <div className="max-w-[1200px] mx-auto space-y-5 md:px-0 px-3">
                <div className="flex justify-between items-center">
                    <div className="md:w-[50%]">
                        <h2 className="text-[32px] font-bold md:text-[26px] lg:text-[30px] xl:text-[38px] leading-[110%]">Blogs</h2>
                        <p className="text-sm italic">
                            Explore ideas, tips, and trends in coding, tech, and innovation. From tutorials to career advice, our blogs are here to inform, inspire, and empower your journey.
                        </p>
                    </div>
                    <div className="hidden lg:block">
                        <a href="#" className="text-[var(--red)] font-semibold hover:underline flex items-center gap-1.5 text-[15px] justify-center mt-4 mb-5">
