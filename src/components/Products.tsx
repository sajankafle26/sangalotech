  ...
  active ? (
    <div className="grid md:grid-cols-2 gap-10 items-center">
      <div>
        ...
        <a
          href="#"
          className="px-5 py-2 bg-[#00548B] text-white rounded-lg font-medium shadow hover:bg-[#003f66] transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg"
        >
          Learn More
        </a>
      </div>
          ...
          <div className="flex justify-center flex-wrap gap-4 mb-8">
            <button
              ...
              className={`px-5 py-2 rounded-lg font-medium shadow-sm transition ${
                activeTab === 'school' ? 'bg-[#00548B] text-white' : 'bg-white text-gray-700 border'
              }`}
            >
            ...
            <button
              ...
              className={`px-5 py-2 rounded-lg font-medium shadow-sm transition ${
                activeTab === 'news' ? 'bg-[#00548B] text-white' : 'bg-white text-gray-700 border'
              }`}
            >
            ...
            <button
              ...
              className={`px-5 py-2 rounded-lg font-medium shadow-sm transition ${
                activeTab === 'clinic' ? 'bg-[#00548B] text-white' : 'bg-white text-gray-700 border'
              }`}
            >
