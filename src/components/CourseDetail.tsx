              ...
              <div>
                ...
                >
                  {course.testimonials.map((testimonial, index) => (
                    <SwiperSlide key={testimonial.id || index} className="bg-white p-8 rounded-lg">
          ...
          <div className="mt-10 lg:mt-0">
            <div className="sticky top-24 bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <button className="w-full bg-red-500 text-white font-bold py-3 rounded-lg hover:bg-red-600 transition-all duration-300 transform hover:-translate-y-1 shadow-lg hover:shadow-xl">
                  Enroll Now
                </button>
                <ul className="mt-6 text-sm space-y-3">
                  ...
                  <li className="flex items-center gap-3">
                    <i className="fas fa-infinity text-gray-500"></i>
